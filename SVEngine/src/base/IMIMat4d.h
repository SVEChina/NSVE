...
namespace imi {
    ...
    IMI_ALIGNED16(struct) DMat4 {
        ...
        explicit DMat4(const IMIQuat &q);
        DMat4(const f64 *m);
        DMat4(const FMat3 &m,const DVec3 &v);
        DMat4(const IMIQuat &q,const DVec3 &v);
        ...
        void set(const IMIQuat &q,const DVec3 &v);
    ...
    //
    void decomposeTransform(const DMat4 &m,DVec3 &position,IMIQuat &rot,FVec3 &scale);
    DMat4 &composeTransform(DMat4 &ret,const DVec3 &position,const IMIQuat &rot,const FVec3 &scale);
