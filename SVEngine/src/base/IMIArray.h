...
namespace imi {
        ...
        template <class Type,class Counter = s32> class IMIArray {
        public:
            class Iterator {
            private:
                friend class IMIArray;
                Iterator(Type *ptr)
                : ptr(ptr) {
                }
            ...
            IMIArray(const Type &t,s32 size)
            : length(0)
            , capacity(0)
            , data(0) {
                resize(size);
            ...
            IMIArray(const Type *v,s32 size)
            : length(0)
            , capacity(0)
            , data(0) {
                append(v,size);
            ...
            IMIArray &operator=(const IMIArray &v) {
                if(this == &v) {
                    return *this;
                }
                resize(v.length);
            ...
            void swap(IMIArray &v) {
                ...
                if((capacity & DYNAMIC_FLAG) && (v.capacity & DYNAMIC_FLAG)) {
                    ...
                    IMIArray<Type> temp = *this;
                    *this = v;
                    v = temp;
                }
            }
            
            sv_inline Type &operator[](s32 index) {                assert((u32)index < (u32)length && "IMIArray::operator[](): bad index");
                return data[index];
            }
            sv_inline const Type &operator[](s32 index) const {
                assert((u32)index < (u32)length && "IMIArray::operator[](): bad index");
                return data[index];
            }
            
            sv_inline void set(s32 index,const Type &t) {
                assert((u32)index < (u32)length && "IMIArray::set(): bad index");
                data[index] = t;
            }
            
            sv_inline Type &get(s32 index) {
                assert((u32)index < (u32)length && "IMIArray::get(): bad index");
                return data[index];
            }
            ...
            void append(s32 pos,const Type &t) {
                assert((u32)pos <= (u32)length && "IMIArray::append(): bad position");
                if(length + 1 <= (capacity & CAPACITY_MASK)) {
            ...
            sv_inline void remove() {
                assert(length > 0 && "IMIArray::remove(): bad length");
                length--;
            }
            
            void remove(s32 pos,s32 size = 1) {
                assert((u32)pos < (u32)length && "IMIArray::remove(): bad position");
                assert(size >= 0 && pos + size <= length && "IMIArray::remove(): bad size");
            ...
            sv_inline void removeFast(s32 pos) {
                assert((u32)pos < (u32)length && "IMIArray::removeFast(): bad position");
        ...
        //
        template <class Type,s32 Capacity = 128,class Counter = s32> class IMIArrayStack : public IMIArray<Type,Counter> {
        public:
            IMIArrayStack() {
                IMIArray<Type,Counter>::capacity = Capacity;
                IMIArray<Type,Counter>::data = stack_data;
            }
            
            explicit IMIArrayStack(s32 size) {
                IMIArray<Type,Counter>::capacity = Capacity;
                IMIArray<Type,Counter>::data = stack_data;
                IMIArray<Type,Counter>::resize(size);
            }
            
            IMIArrayStack(const IMIArray<Type,Counter> &v) {
                IMIArray<Type,Counter>::capacity = Capacity;
                IMIArray<Type,Counter>::data = stack_data;
                IMIArray<Type,Counter>::append(v);
            }
            
            IMIArrayStack(const Type &t,s32 size) {
                IMIArray<Type,Counter>::capacity = Capacity;
                IMIArray<Type,Counter>::data = stack_data;
                IMIArray<Type,Counter>::resize(size);
                for(s32 i = 0; i < size; i++) {
                    IMIArray<Type,Counter>::data[i] = t;
                }
            }
            
            IMIArrayStack(const Type *v,s32 size) {
                IMIArray<Type,Counter>::capacity = Capacity;
                IMIArray<Type,Counter>::data = stack_data;
                IMIArray<Type,Counter>::append(v,size);
            }
            
            ~IMIArrayStack() {
            }
            
            IMIArrayStack &operator=(const IMIArrayStack &v) {
                if(this == &v)
                    return *this;
                IMIArray<Type,Counter>::resize(v.length);
                for(s32 i = 0; i < IMIArray<Type,Counter>::length; i++) {
                    IMIArray<Type,Counter>::data[i] = v.data[i];
                }
                return *this;
            }
            
            IMIArrayStack &operator=(const IMIArray<Type,Counter> &v) {
                if(this == &v)
                    return *this;
                IMIArray<Type,Counter>::resize(v.size());
                for(s32 i = 0; i < IMIArray<Type,Counter>::length; i++) {
                    IMIArray<Type,Counter>::data[i] = v[i];
                }
                return *this;
            }
            
            void destroy() {
                IMIArray<Type,Counter>::destroy();
                IMIArray<Type,Counter>::capacity = Capacity;
                IMIArray<Type,Counter>::data = stack_data;
            }
        private:
