#ifndef __IMI_VEC3_H__
#define __IMI_VEC3_H__
...
namespace imi {
    ...
    //
    IMI_ALIGNED8(struct) HVec3 {
        
        sv_inline HVec3() { }
        sv_inline HVec3(const HVec3 &v) : x(v.x), y(v.y), z(v.z) { }
        sv_inline HVec3(IMIHalf x,IMIHalf y,IMIHalf z) : x(x), y(y), z(z) { }
        explicit sv_inline HVec3(IMIHalf v) : x(v), y(v), z(v) { }
