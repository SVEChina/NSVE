...
namespace imi {
        ...
        template <class Key,class Data,u16 Capacity> class IMICoreTree {
            
        public:
            
            // IMICoreTree::Iterator
            class Iterator;
            ...
            private:
                ...
                friend class IMICoreTree<Key,Data,Capacity>;
                friend class IMICoreTree<Key,Data,Capacity>::Iterator;
