#ifndef __IMI_VEC4_H__
#define __IMI_VEC4_H__
...
namespace imi {
    ...
    IMI_ALIGNED8(struct) HVec4 {
        ...
        //
        sv_inline HVec4(IMIHalf x,IMIHalf y,IMIHalf z,IMIHalf w)
        : x(x)
        , y(y)
        , z(z)
        , w(w) {
        ...
        //
        explicit sv_inline HVec4(IMIHalf v)
        : x(v)
        , y(v)
        , z(v)
        , w(v) {
