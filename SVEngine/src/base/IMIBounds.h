...
#include "IMIBase.h"
#include "IMIGeometry.h"

//

namespace imi {
    
        class IMIBoundSphere;
        class IMIBoundBox;
        class IMIBoundFrustum;
        /**
         *IMIBoundSphere
         */
        class IMIBoundSphere {
        public:
            IMIBoundSphere();
            //
            IMIBoundSphere(const FVec3 &center,f32 radius);
            //
            IMIBoundSphere(const FVec3 *points,s32 num_points,s32 optimal);
            //
            IMIBoundSphere(const IMIBoundSphere &bs);
            //
            IMIBoundSphere(const IMIBoundSphere &bs,const FMat4 &transform);
            //
            explicit IMIBoundSphere(const IMIBoundBox &bb);
            //
            ~IMIBoundSphere();
            //
            void clear();
            ...
            //
            void set(const IMIBoundSphere &bs);
            //
            void set(const IMIBoundSphere &bs,const FMat4 &transform);
            //
            void set(const IMIBoundBox &bb);
            // transformation
            void setTransform(const FMat4 &transform);
            //
            void setTransform(const DMat4 &transform);
            // compare
            s32 compare(const IMIBoundSphere &bs) const;
            //
            sv_inline s32 operator==(const IMIBoundSphere &bs) const {
                return compare(bs);
            }
            //
            sv_inline s32 operator!=(const IMIBoundSphere &bs) const {
            ...
            //
            void expand(const IMIBoundSphere &bs);
            //
            void expand(const IMIBoundBox &bb);
            // radius expand
            void expandRadius(const FVec3 &point);
            //
            void expandRadius(const FVec3 *points,s32 num_points);
            //
            void expandRadius(const IMIBoundSphere &bs);
            //
            void expandRadius(const IMIBoundBox &bb);
            // inside points
            ...
            // inside bounds
            s32 inside(const IMIBoundSphere &bs) const;
            //
            s32 inside(const IMIBoundBox &bb) const;
            //
            s32 insideValid(const IMIBoundSphere &bs) const;
            //
            s32 insideValid(const IMIBoundBox &bb) const;
            //
            s32 insideAll(const IMIBoundSphere &bs) const;
            ////
            s32 insideAll(const IMIBoundBox &bb) const;
            
            s32 insideAllValid(const IMIBoundSphere &bs) const;
            //
            s32 insideAllValid(const IMIBoundBox &bb) const;
            // intersections
        ...
        //
        sv_inline s32 IMIBoundSphere::insideValid(const FVec3 &point) const {
            return (length2(center - point) <= center.w * center.w);
        }
        
        sv_inline s32 IMIBoundSphere::insideValid(const FVec3 &point,f32 radius) const {
            radius += center.w;
            return (length2(center - point) <= radius * radius);
        }
        
        sv_inline s32 IMIBoundSphere::insideValid(const FVec3 &min,const FVec3 &max) const {
#ifdef USE_SSE
        ...
        //
        sv_inline s32 IMIBoundSphere::insideValid(const IMIBoundSphere &bs) const {
            return insideValid(bs.center,bs.center.w);
        }
        //
        sv_inline s32 IMIBoundSphere::insideAllValid(const IMIBoundSphere &bs) const {
            f32 radius = center.w - bs.center.w;
            if(radius > 0.0f) return (length2(center - bs.center) <= radius * radius);
            return 0;
        }
        //
        sv_inline s32 IMIBoundSphere::rayIntersectionValid(const FVec3 &point,const FVec3 &direction) const {
            f32 k = saturate(dot(direction,center - point) / length2(direction));
            return (length2(center - point - direction * k) <= center.w * center.w);
        }
        //
        sv_inline s32 IMIBoundSphere::getIntersectionValid(const FVec3 &p0,const FVec3 &p1) const {
            return rayIntersectionValid(p0,p1 - p0);
        }
        //
        sv_inline f32 IMIBoundSphere::distanceValid() const {
#ifdef USE_SSE
            f32 ret;
        ...
        //
        sv_inline f32 IMIBoundSphere::distanceValid(const FVec3 &point) const {
#ifdef USE_SSE
            f32 ret;
        ...
        public:
            IMIBoundBox();
            IMIBoundBox(const FVec3 &min,const FVec3 &max);
            IMIBoundBox(const FVec3 *points,s32 num_points);
            IMIBoundBox(const IMIBoundBox &bb);
            IMIBoundBox(const IMIBoundBox &bb,const FMat4 &transform);
            explicit IMIBoundBox(const IMIBoundSphere &bs);
            ~IMIBoundBox();
            //
            void clear();
            //
            ...
            void set(const IMIBoundSphere &bs);
            void set(const IMIBoundBox &bb);
            void set(const IMIBoundBox &bb,const FMat4 &transform);
            // transformation
            void setTransform(const FMat4 &transform);
            void setTransform(const DMat4 &transform);
            void setTransform(const IMIBoundSphere &bs,const FMat4 &transform);
            void setTransform(const IMIBoundSphere &bs,const DMat4 &transform);
            // compare
            s32 compare(const IMIBoundBox &bb) const;
            sv_inline s32 operator==(const IMIBoundBox &bb) const { return compare(bb); }
            sv_inline s32 operator!=(const IMIBoundBox &bb) const { return !compare(bb); }
            // expand
            void expand(const FVec3 &point);
            void expand(const FVec3 *points,s32 num_points);
        ...
        //
        sv_inline s32 IMIBoundSphere::insideValid(const IMIBoundBox &bb) const {
            return insideValid(bb.getMin(),bb.getMax());
        }
        
        //
        sv_inline s32 IMIBoundSphere::insideAllValid(const IMIBoundBox &bb) const {
        ...
        //
        sv_inline s32 IMIBoundBox::insideValid(const FVec3 &point) const {
#ifdef USE_SSE
        ...
        //
        sv_inline s32 IMIBoundBox::insideValid(const FVec3 &point,f32 radius) const {
#ifdef USE_SSE
        ...
        //
        sv_inline s32 IMIBoundBox::insideValid(const FVec3 &min_,const FVec3 &max_) const {
#ifdef USE_SSE
        ...
        //
        sv_inline s32 IMIBoundBox::insideValid(const IMIBoundSphere &bs) const {
        ...
        //
        sv_inline s32 IMIBoundBox::insideValid(const IMIBoundBox &bb) const {
            return insideValid(bb.min,bb.max);
        }
        //
        sv_inline s32 IMIBoundBox::insideAllValid(const IMIBoundSphere &bs) const {
            const FVec3 &center = bs.getCenter();
#ifdef USE_SSE
            __m128 radius = _MM_SWIZZLE(center.vec,W,W,W,W);
        ...
        //
        sv_inline s32 IMIBoundBox::insideAllValid(const IMIBoundBox &bb) const {
#ifdef USE_SSE
        ...
        //
        sv_inline s32 IMIBoundBox::rayIntersectionValid(const FVec3 &point,const FVec3 &direction) const {
            return rayBoundBoxIntersection(point,direction,min,max);
        }
        
        sv_inline s32 IMIBoundBox::irayIntersectionValid(const FVec3 &point,const FVec3 &idirection) const {
            return irayBoundBoxIntersection(point,idirection,min,max);
        }
        
        sv_inline s32 IMIBoundBox::getIntersectionValid(const FVec3 &p0,const FVec3 &p1) const {
            return rayBoundBoxIntersection(p0,p1 - p0,min,max);
        }
        //
        sv_inline f32 IMIBoundBox::distanceValid() const {
#ifdef USE_SSE
            f32 ret;
        ...
        sv_inline f32 IMIBoundBox::distanceValid(const FVec3 &point) const {
#ifdef USE_SSE
            f32 ret;
        ...
        public:
            IMIBoundFrustum();
            IMIBoundFrustum(const FMat4 &projection,const FMat4 &modelview);
            IMIBoundFrustum(const IMIBoundFrustum &bf);
            IMIBoundFrustum(const IMIBoundFrustum &bf,const FMat4 &itransform);
            ~IMIBoundFrustum();
            
            void clear();
            
            void set(const FMat4 &projection,const FMat4 &modelview);
            void set(const IMIBoundFrustum &bf);
            void set(const IMIBoundFrustum &bf,const FMat4 &itransform);
            ...
            // compare
            s32 compare(const IMIBoundFrustum &bf) const;
            sv_inline s32 operator==(const IMIBoundFrustum &bf) const { return compare(bf); }
            sv_inline s32 operator!=(const IMIBoundFrustum &bf) const { return !compare(bf); }
            ...
            s32 inside(const IMIBoundSphere &bs) const;
            s32 inside(const IMIBoundBox &bb) const;
            s32 inside(const IMIBoundFrustum &bf) const;
            
            s32 insideValid(const IMIBoundSphere &bs) const;
            s32 insideValid(const IMIBoundBox &bb) const;
            s32 insideValid(const IMIBoundFrustum &bf) const;
            
            s32 insideValidFast(const IMIBoundSphere &bs) const;
            s32 insideValidFast(const IMIBoundBox &bb) const;
            s32 insideValidFast(const IMIBoundFrustum &bf) const;
            
            // inside all bounds
            s32 insideAll(const IMIBoundSphere &bs) const;
            s32 insideAll(const IMIBoundBox &bb) const;
            s32 insideAll(const IMIBoundFrustum &bf) const;
            
            s32 insideAllValid(const IMIBoundSphere &bs) const;
            s32 insideAllValid(const IMIBoundBox &bb) const;
            s32 insideAllValid(const IMIBoundFrustum &bf) const;
            
            s32 insideAllValidFast(const IMIBoundSphere &bs) const;
            s32 insideAllValidFast(const IMIBoundBox &bb) const;
            s32 insideAllValidFast(const IMIBoundFrustum &bf) const;
            
            // inside planes bounds
            s32 insidePlanes(const IMIBoundSphere &bs) const;
            s32 insidePlanes(const IMIBoundBox &bb) const;
            s32 insidePlanes(const IMIBoundFrustum &bf) const;
            
            s32 insidePlanesValid(const IMIBoundSphere &bs) const;
            s32 insidePlanesValid(const IMIBoundBox &bb) const;
            s32 insidePlanesValid(const IMIBoundFrustum &bf) const;
            
            s32 insidePlanesValidFast(const IMIBoundSphere &bs) const;
            s32 insidePlanesValidFast(const IMIBoundBox &bb) const;
            s32 insidePlanesValidFast(const IMIBoundFrustum &bf) const;
            
            // inside portals
            s32 insidePortals(const IMIBoundSphere &bs) const;
            s32 insidePortals(const IMIBoundBox &bb) const;
            s32 insidePortals(const IMIBoundFrustum &bf) const;
            
            s32 insidePortalsValid(const IMIBoundSphere &bs) const;
            s32 insidePortalsValid(const IMIBoundBox &bb) const;
            s32 insidePortalsValid(const IMIBoundFrustum &bf) const;
            
            // inside shadow
            s32 insideShadow(const FVec3 &direction,const IMIBoundSphere &object) const;
            s32 insideShadow(const IMIBoundSphere &light,const FVec3 &offset,const IMIBoundSphere &object) const;
        ...
        private:
            ...
            //IMIArrayStack<Portal,16> portals;    // portals
        };
        
        //
        sv_inline s32 IMIBoundFrustum::inside(const FVec3 &point) const {
            if(inside_portals(point) == 0)
                return 0;
            return inside_planes(point);
        }
        
        sv_inline s32 IMIBoundFrustum::inside(const FVec3 &point,f32 radius) const {
            if(inside_portals(point,radius) == 0)
                return 0;
            return inside_planes(point,radius);
        }
        
        sv_inline s32 IMIBoundFrustum::inside(const FVec3 &min,const FVec3 &max) const {
            if(inside_portals(min,max) == 0)
                return 0;
            return inside_planes(min,max);
        }
        
        sv_inline s32 IMIBoundFrustum::inside(const FVec3 *points,s32 num_points) const {
        ...
        //
        sv_inline s32 IMIBoundFrustum::insideFast(const FVec3 &point) const {
            if(inside_portals(point) == 0)
                return 0;
            return inside_planes_fast(point);
        }
        
        sv_inline s32 IMIBoundFrustum::insideFast(const FVec3 &point,f32 radius) const {
            if(inside_portals(point,radius) == 0)
                return 0;
            return inside_planes_fast(point,radius);
        }
        
        sv_inline s32 IMIBoundFrustum::insideFast(const FVec3 &min,const FVec3 &max) const {
            if(inside_portals(min,max) == 0)
                return 0;
            return inside_planes_fast(min,max);
        }
        
        sv_inline s32 IMIBoundFrustum::insideFast(const FVec3 *points,s32 num_points) const {
            if(inside_portals(points,num_points) == 0)
                return 0;
            return inside_planes_fast(points,num_points);
        }
        //
        sv_inline s32 IMIBoundFrustum::insideValid(const IMIBoundSphere &bs) const {
            return inside(bs.getCenter(),bs.getRadius());
        }
        
        sv_inline s32 IMIBoundFrustum::insideValid(const IMIBoundBox &bb) const {
            return inside(bb.getMin(),bb.getMax());
        }
        
        sv_inline s32 IMIBoundFrustum::insideValid(const IMIBoundFrustum &bf) const {
            return inside(bf.points,8);
        }
        //
        sv_inline s32 IMIBoundFrustum::insideValidFast(const IMIBoundSphere &bs) const {
            return insideFast(bs.getCenter(),bs.getRadius());
        }
        
        sv_inline s32 IMIBoundFrustum::insideValidFast(const IMIBoundBox &bb) const {
            return insideFast(bb.getMin(),bb.getMax());
        }
        
        sv_inline s32 IMIBoundFrustum::insideValidFast(const IMIBoundFrustum &bf) const {
            return insideFast(bf.points,8);
        }
        
        //
        sv_inline s32 IMIBoundFrustum::insideAllValid(const IMIBoundSphere &bs) const {
            return inside(bs.getCenter(),-bs.getRadius());
        }
        
        sv_inline s32 IMIBoundFrustum::insideAllValid(const IMIBoundBox &bb) const {
            const FVec3 &min = bb.getMin();
            const FVec3 &max = bb.getMax();
        ...
        sv_inline s32 IMIBoundFrustum::insideAllValid(const IMIBoundFrustum &bf) const {
            for(s32 i = 0; i < 8; i++) {
        ...
        //
        sv_inline s32 IMIBoundFrustum::insideAllValidFast(const IMIBoundSphere &bs) const {
            return insideFast(bs.getCenter(),-bs.getRadius());
        }
        
        sv_inline s32 IMIBoundFrustum::insideAllValidFast(const IMIBoundBox &bb) const {
            const FVec3 &min = bb.getMin();
            const FVec3 &max = bb.getMax();
        ...
        sv_inline s32 IMIBoundFrustum::insideAllValidFast(const IMIBoundFrustum &bf) const {
            for(s32 i = 0; i < 8; i++) {
        ...
        //
        sv_inline s32 IMIBoundFrustum::insidePlanesValid(const IMIBoundSphere &bs) const {
            return inside_planes(bs.getCenter(),bs.getRadius());
        }
        
        sv_inline s32 IMIBoundFrustum::insidePlanesValid(const IMIBoundBox &bb) const {
            return inside_planes(bb.getMin(),bb.getMax());
        }
        
        sv_inline s32 IMIBoundFrustum::insidePlanesValid(const IMIBoundFrustum &bf) const {
            return inside_planes(bf.points,8);
        }
        
        //
        sv_inline s32 IMIBoundFrustum::insidePlanesValidFast(const IMIBoundSphere &bs) const {
            return inside_planes_fast(bs.getCenter(),bs.getRadius());
        }
        
        sv_inline s32 IMIBoundFrustum::insidePlanesValidFast(const IMIBoundBox &bb) const {
            return inside_planes_fast(bb.getMin(),bb.getMax());
        }
        
        sv_inline s32 IMIBoundFrustum::insidePlanesValidFast(const IMIBoundFrustum &bf) const {
            return inside_planes_fast(bf.points,8);
        }
        
        //
        sv_inline s32 IMIBoundFrustum::insidePortalsValid(const IMIBoundSphere &bs) const {
            return inside_portals(bs.getCenter(),bs.getRadius());
        }
        
        sv_inline s32 IMIBoundFrustum::insidePortalsValid(const IMIBoundBox &bb) const {
            return inside_portals(bb.getMin(),bb.getMax());
        }
        
        sv_inline s32 IMIBoundFrustum::insidePortalsValid(const IMIBoundFrustum &bf) const {
