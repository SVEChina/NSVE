...
/*
 */
u32 IMINoise::get_random_int() {
	m_seed = (u32)((unsigned long long)m_seed * A + C) & MAX_RANDOM;
	return m_seed;
}

f32 IMINoise::get_random_float() {
...
/*
 */
f32 IMINoise::get1(f32 _x) const {
...
f32 IMINoise::get2(f32 _x, f32 _y) const {
...
f32 IMINoise::get3(f32 _x, f32 _y, f32 _z) const {
...
/*
 */
f32 IMINoise::getTurbulence1(f32 _x, s32 _frequency) const {
	f32 res = 0.0f;
...
f32 IMINoise::getTurbulence2(f32 _x, f32 _y, s32 _frequency) const {
	f32 res = 0.0f;
	for(s32 f = _frequency; f >= 1; f >>= 1) {
...
f32 IMINoise::getTurbulence3(f32 _x, f32 _y, f32 _z, s32 _frequency) const {
	f32 res = 0.0f;
	for(s32 f = _frequency; f >= 1; f >>= 1) {
...
/*
 */
f32 IMINoise::getTileable1(f32 _x,f32 _width) const {
	_x -= (s32)(_x / _width) * _width;
	if(_x < 0.0f) _x += _width;
	return (get1(_x) * (_width - _x) + get1(_x - _width) * _x) / _width;
}

f32 IMINoise::getTileable2(f32 _x, f32 _y, f32 _width, f32 _height) const {
	_x -= (s32)(_x / _width) * _width;
...
f32 IMINoise::getTileable3(f32 _x, f32 _y, f32 _z, f32 _width, f32 _height, f32 _depth) const {
	_x -= (s32)(_x / _width) * _width;
	_y -= (s32)(_y / _height) * _height;
...
/*
 */
f32 IMINoise::getTileableTurbulence1(f32 _x, f32 _width, s32 _frequency) const {
	f32 res = 0.0f;
	for(s32 f = _frequency; f >= 1; f >>= 1) {
...
f32 IMINoise::getTileableTurbulence2(f32 _x, f32 _y, f32 _width, f32 _height, s32 _frequency) const {
	f32 res = 0.0f;
	for(s32 f = _frequency; f >= 1; f >>= 1) {
...
f32 IMINoise::getTileableTurbulence3(f32 _x, f32 _y, f32 _z, f32 _width, f32 _height, f32 _depth, s32 _frequency) const{
	f32 res = 0.0f;
	for(s32 f = _frequency; f >= 1; f >>= 1) {
