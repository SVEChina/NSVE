...
namespace imi {
    ...
    template <class Key,class Data> class IMICoreTree {
    public:
        class Iterator;
        class Node : public Data, public Base {
        private:
            friend class IMICoreTree<Key,Data>;
            friend class IMICoreTree<Key,Data>::Iterator;
        ...
        IMICoreTree(const IMICoreTree &tree)
        : length(0)
        , root(0) {
            Node *dest_parent = 0;
        ...
        IMICoreTree &operator=(const IMICoreTree &tree) {
            if(this == &tree)
                return *this;
            length = 0;
            delete root;
