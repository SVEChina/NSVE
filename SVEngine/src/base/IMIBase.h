...
//
	...
	#ifdef _WIN32
		#define IMI_ALIGNED4(NAME) __declspec(align(4)) NAME
		#define IMI_ALIGNED8(NAME) __declspec(align(8)) NAME
		#define IMI_ALIGNED16(NAME) __declspec(align(16)) NAME
		#define IMI_ALIGNED128(NAME) __declspec(align(128)) NAME
	#else
		#define IMI_ALIGNED4(NAME) NAME __attribute__ ((aligned(4)))
		#define IMI_ALIGNED8(NAME) NAME __attribute__ ((aligned(8)))
		#define IMI_ALIGNED16(NAME) NAME __attribute__ ((aligned(16)))
		#define IMI_ALIGNED128(NAME) NAME __attribute__ ((aligned(128)))
	#endif
#else
	#define IMI_ALIGNED4(NAME) NAME
	#define IMI_ALIGNED8(NAME) NAME
	#define IMI_ALIGNED16(NAME) NAME
	#define IMI_ALIGNED128(NAME) NAME
#endif
