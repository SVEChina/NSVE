...
#ifndef IMI_PARTICLES_H
#define IMI_PARTICLES_H
...
namespace imi {
        ...
        struct Noise {
            ...
            s32 size;                            // noise size
            IMIImagePtr image;                      // image pointer
        };
        //扭曲
        struct Deflector {
            FMat4 transform;                        // transformation
        ...
        //
        class IMIParticlesWorldBase : public IMIGBaseEx {
        public:
            IMIParticlesWorldBase(IMIInstPtr _app)
            :IMIGBaseEx(_app) {
            }

            ~IMIParticlesWorldBase() {
            }
            ...
            // fields
            virtual s32 getFields(IMIArray<WorldField> &fields){ return 0; };
            
            // forces
            virtual s32 getForces(IMIArray<WorldForce> &forces){ return 0; };
            
            // noises
            virtual s32 getNoises(IMIArray<WorldNoise> &noises){ return 0; };
            
            // intersection
            virtual s32 getIntersection(const FVec3 &p0,const FVec3 &p1,WorldContact &contact){ return 0; };
            
            // collision
            virtual s32 getCollision(const FVec3 &point,const FVec3 &velocity,f32 radius,IMIArray<WorldContact> &contacts,f32 ifps){ return 0; };
        ...
        //一堆粒子算法
        class IMIParticles :public IMIGBaseEx {
            friend struct ParticlesDistanceCompare;
            friend class IMIParticlesNode;
        public:
            IMIParticles(IMIInstPtr _app);
            
            virtual ~IMIParticles();
            ...
            //世界
            void setWorld(IMIParticlesWorldBasePtr _world);
            
            IMIParticlesWorldBasePtr getWorld();
        ...
        public:
            ...
            IMIImagePtr getNoiseImage(s32 num);
            ...
            // bounds
            sv_inline const IMIBoundBox &getIMIBoundBox() const {
                return bound_box;
            }
            
            sv_inline const IMIBoundSphere &getIMIBoundSphere() const {
                return bound_sphere;
            }
        protected:
            // update particles
            ...
            virtual void update_particles(IMIArray<WorldField> &world_fields,
            ...
            IMIRandom random;                        // random number generator
            
            IMIParticlesWorldBasePtr m_pWorld;       // world interaction
            ...
            IMIArray<Force> forces;
            IMIArray<Noise> noises;
            IMIArray<Deflector> deflectors;
            IMIArray<Distance> distances;
            IMIArray<Particle> m_particles;
            IMIArray<s32> remove;
            IMIArray<Spark> sparks;                    // spark points
            IMIArray<Contact> contacts;                // contacts
            IMIArray<Contact> old_contacts;            // old contacts
            
            //包围盒
            IMIBoundBox bound_box;                        // bounds
            IMIBoundSphere bound_sphere;
            IMIBoundBox particles_bound_box;
