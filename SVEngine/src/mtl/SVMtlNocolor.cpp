...
void SVMtlNocolor::_submitMtl(render::SVRendererPtr _render) {
...
void SVMtlGeo3d::_submitMtl(render::SVRendererPtr _render) {
    SVMtlCore::_submitMtl(_render);
...
void SVMtlCoord::_submitMtl(render::SVRendererPtr _render) {
    SVMtlCore::_submitMtl(_render);
}
...
void SVMtlNetGrid::_submitMtl(render::SVRendererPtr _render) {
    SVMtlCore::_submitMtl(_render);
...
void SVMtlParticleAni::_submitMtl(render::SVRendererPtr _render) {
    SVMtlCore::_submitMtl(_render);
