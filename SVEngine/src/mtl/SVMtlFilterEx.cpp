...
void SVMtlBrightnessContrast::_submitMtl(render::SVRendererPtr _render) {
...
void SVMtlSaturation::_submitMtl(render::SVRendererPtr _render) {
    SVMtlCore::_submitMtl(_render);
...
void SVMtlVibrance::_submitMtl(render::SVRendererPtr _render) {
    SVMtlCore::_submitMtl(_render);
...
void SVMtlShadowHighlight::_submitMtl(render::SVRendererPtr _render){
    SVMtlCore::_submitMtl(_render);
...
void SVMtlWhiteBlackLevel::_submitMtl(render::SVRendererPtr _render){
    SVMtlCore::_submitMtl(_render);
    _render->submitUniformf("shadows", m_shadow);
    _render->submitUniformf("highlights", m_HighLight);
}
...
void SVMtlColorBalance::_submitMtl(render::SVRendererPtr _render){
     SVMtlCore::_submitMtl(_render);
...
void SVMtlHSL::_submitMtl(render::SVRendererPtr _render){
    SVMtlCore::_submitMtl(_render);
...
void SVMtlWhiteBalance::_submitMtl(render::SVRendererPtr _render){
    SVMtlCore::_submitMtl(_render);
...
void SVMtlGamma::_submitMtl(render::SVRendererPtr _render){
    SVMtlCore::_submitMtl(_render);
...
void SVMtlExposure::_submitMtl(render::SVRendererPtr _render){
    SVMtlCore::_submitMtl(_render);
