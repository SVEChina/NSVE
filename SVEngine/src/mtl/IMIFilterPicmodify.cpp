//
// IMIFilterPicmodify.cpp
// IMIngine
// Copyright 2017-2020
// yizhou.Fu
//

#include "IMIFilterPicmodify.h"
...
IMIFilterPicmodify::IMIFilterPicmodify(IMIInstPtr _app)
:IMIFilterBase(_app){
}

IMIFilterPicmodify::~IMIFilterPicmodify(){
}

//创建
bool IMIFilterPicmodify::create() {
//    s32 t_w =  mApp->m_global_param.sv_width;
//    s32 t_h =  mApp->m_global_param.sv_height;
//    //创建材质
//    m_acutancemtl=MakeSharedPtr<IMIMtlAcutance>(mApp);
...
//    m_baseOnmtl=MakeSharedPtr<IMIMtlBasedOn>(mApp);
...
//    //创建pass
//    m_pass = MakeSharedPtr<IMIPass>(mApp);
//    m_pass->setMtl("");
//    IMISurfacePtr t_surface = m_pass->getSurface();
//    if(t_surface) {
//        IMITexturePtr teximg = mApp->getTexMgr()->getTexture("svres/filterimg/facewhitefilter.png", true);
...
//    //
//    IMIPassPtr t_pass2 = MakeSharedPtr<IMIPass>(mApp);
...
//void IMIFilterPicmodify::setFilterParam(f32 _value,IMIFILTERITEMTYPE _type){
////    if (m_mtl) {
...
//}
//
//f32 IMIFilterPicmodify::getFilterParam(IMIFILTERITEMTYPE _type){
////    if(_type==E_SHADOWS_FILTER){
////        return getShadows();
////    }else if(_type==E_CONTRAST_FILTER){
////        return getContrast();
...
//销毁
void IMIFilterPicmodify::destroy() {
}

void IMIFilterPicmodify::update(f32 _dt){
...
//        //IMIShaderPtr t_shader = m_mtl->getShader();
//        //t_shader->submitParam(<#IMIParamTblPtr _param#>)
//    }
////    m_pass->update(_dt);
////    //
////    if(m_acutancemtl){
