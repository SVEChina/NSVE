...
#ifndef IMI_MTLFACESHAPE_H
#define IMI_MTLFACESHAPE_H

#include "IMIMtlCore.h"

namespace imi {
    
    class IMIMtlFaceShape : public IMIMtlCore {
    public:
        IMIMtlFaceShape(IMIInstPtr _app);
        
        IMIMtlFaceShape(IMIMtlFaceShape *_mtl);
