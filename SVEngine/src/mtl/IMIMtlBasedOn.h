...
namespace imi {
    ...
    class IMIMtlBasedOn : public IMIMtlCore {
    public:
        IMIMtlBasedOn(IMIInstPtr _app);
        
        IMIMtlBasedOn(IMIMtlBasedOn* _mtl);
    ...
    class IMIMtlAcutance : public IMIMtlCore {
    public:
        IMIMtlAcutance(IMIInstPtr _app);
        
        IMIMtlAcutance(IMIMtlAcutance *_mtl);
