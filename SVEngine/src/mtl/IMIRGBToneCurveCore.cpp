...
void createSecondDerivative(IMIArray<V2> points ,IMIArray<f64> *outarray){
    int n = points.size();
    if (n <= 1) {
        return ;
    }
...
void createSplineCurve2(IMIArray<V2> points,IMIArray<V2> *output ) {
    IMIArray<f64> sdA;
...
void createSplineCurve(IMIArray<V2> points,IMIArray<f32> *preparedSplinePoints) {
    if (points.size() <= 0) {
        return ;
    }

    IMIArray<V2> pointsSorted = points;
    IMIArray<V2> convertedPoints;
...
void getPreparedSplineCurve(IMIArray<V2>  mRgbCompositeControlPoints,
                            IMIArray<V2>  mRedControlPoints,
                            IMIArray<V2>  mGreenControlPoints,
                            IMIArray<V2>  mBlueControlPoints, u8* outRgba){
    IMIArray<f32> outPointsRGB;
    IMIArray<f32> outPointsR;
    IMIArray<f32> outPointsG;
    IMIArray<f32> outPointsB;
