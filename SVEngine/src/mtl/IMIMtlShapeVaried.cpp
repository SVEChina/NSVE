...
IMIMtlFaceShapeVaried::IMIMtlFaceShapeVaried(IMIInstPtr _app)
:IMIMtlCore(_app,"faceShapeVaried"){
...
IMIMtlFaceShapeVaried::IMIMtlFaceShapeVaried(IMIMtlFaceShapeVaried *_mtl)
:IMIMtlCore(_mtl){
...
IMIMtlFaceShapeVaried::~IMIMtlFaceShapeVaried(){
    
}

IMIMtlCorePtr IMIMtlFaceShapeVaried::clone(){
    return PointerSharedPtr<IMIMtlFaceShapeVaried>(new IMIMtlFaceShapeVaried(this));
}

void IMIMtlFaceShapeVaried::update(f32 dt){
...
void IMIMtlFaceShapeVaried::_submitMtl(IMIRendererPtr _render){
