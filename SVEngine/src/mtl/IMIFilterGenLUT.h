...
#ifndef IMI_FILTERLOOKUPTABLEADJUST_H
#define IMI_FILTERLOOKUPTABLEADJUST_H
...
namespace imi {
    ...
    class IMIGenLUTParam :public IMIObject {
    public:
        IMIGenLUTParam(){
            reset();
        };
        ...
        void copy(IMIGenLUTParamPtr _p){
    ...
    //
    class IMIFilterGenLUT : public IMIFilterBase {
    public:
        IMIFilterGenLUT(IMIInstPtr _app);
        ...
        void refreshFData(IMIGenLUTParamPtr _param);
        
        IMIGenLUTParamPtr getLUTparam(){
            return m_genParam;
        }
        
    protected:
        IMIMtlBrightnessContrastPtr m_BCMtl;//brightness contrast
        IMIMtlSaturationPtr m_SaturationMtl;
        IMIMtlVibrancePtr m_VibranceMtl;
        IMIMtlColorBalancePtr m_colorBalanceMtl;
        IMIMtlShadowHighlightPtr m_shadowHighlightMtl;
        IMIMtlWhiteBlackLevelPtr m_whiteBalckLeveMtl;
        IMIMtlWhiteBalancePtr m_whiteBalanceMtl;
        IMIMtlGammaPtr m_gammaMtl;
        IMIMtlExposurePtr m_exposureMtl;
        IMIMtlHSLPtr m_hslMtl;
        IMIGenLUTParamPtr m_genParam;
        IMIMtlGradientMapPtr m_gradientMapMtl;
        //
        IMIPassPtr m_GradientMapPass;
...
#endif /* IMI_FILTERLOOKUPTABLEADJUST_H */
