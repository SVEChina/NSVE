...
#ifndef IMI_EVENTDEF_H
#define IMI_EVENTDEF_H

#include "IMIEventDeclare.h"

namespace imi {

    //
    typedef void (*proc_sys_event)(IMIObjectPtr sender,IMIEventPtr _event);
