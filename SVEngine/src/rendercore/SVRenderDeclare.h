...
namespace sv {
    ...
    DECLARE_SHAREPTR(SVRGLTex);
    DECLARE_SHAREPTR(SVRGLTexWithTexID);
    DECLARE_SHAREPTR(SVRGLTexPlist);
    DECLARE_SHAREPTR(SVRGLTexSet);
    DECLARE_SHAREPTR(SVRGLTexiOS);
    DECLARE_SHAREPTR(SVRGLShader);
    ...
    DECLARE_SHAREPTR(SVRMetalTex);
    DECLARE_SHAREPTR(SVRMetalShader);
