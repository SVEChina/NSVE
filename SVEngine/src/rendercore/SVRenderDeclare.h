...
namespace sv {
    ...
    DECLARE_SHAREPTR(SVRBufferGL);
    DECLARE_SHAREPTR(SVRenderStateGL);
    DECLARE_SHAREPTR(SVRTexGL);
    DECLARE_SHAREPTR(SVRTexGLWithTexID);
    DECLARE_SHAREPTR(SVRTexGLPlist);
    DECLARE_SHAREPTR(SVRTexGLSet);
    DECLARE_SHAREPTR(SVRTexGLiOS);
    ...
    DECLARE_SHAREPTR(SVRBufferMetal);
