...
#include "IMIRenderCmdGeo.h"
#include "IMIGL/IMIRTexGL.h"
...
IMIRenderCmdGeo::IMIRenderCmdGeo()
:m_pMtl(nullptr){
}
...
bool IMIRenderCmdGeo::render(IMIRendererPtr _renderer,IMIRTargetPtr _target){
//    if (m_pMtl ) {
//        if (m_pMtl->submitMtl()) {
//           _render();
//            m_pMtl->recoverMtl();
...
void IMIRenderCmdGeo::_render(){
}

//void IMIRenderCmdGeo::setMtl(IMIMtlCorePtr _mtl){
//    m_pMtl = _mtl;
//}

//
void IMIRCmdLine::setLine(FVec3& _start, FVec3& _end){
    m_start = _start;
    m_end = _end;
}

void IMIRCmdLine::_render(IMIRendererPtr _renderer,IMIRTargetPtr _target){
//    V3 t_verts[2];
...
//
void IMIRCmdRect::setRect(IMIRect& _rect){
    m_rect = _rect;
}

void IMIRCmdRect::_render(IMIRendererPtr _renderer,IMIRTargetPtr _target){
//    V3 t_verts[4];
...
void IMIRCmdRectSolid::_render(IMIRendererPtr _renderer,IMIRTargetPtr _target){
//    V3 t_verts[4];
//    t_verts[0].x = m_rect.m_lb_pt.x;
//    t_verts[0].y = m_rect.m_lb_pt.y;
//    t_verts[0].z = 0.0f;
...
void IMIRCmdCurve::_render(IMIRendererPtr _renderer,IMIRTargetPtr _target){
//    V3 t_verts[4];
//    t_verts[0].x = m_rect.m_lb_pt.X;
//    t_verts[0].y = m_rect.m_lb_pt.Y;
//    t_verts[0].z = 0.0f;
...
void IMIRCmdCircle::_render(IMIRendererPtr _renderer,IMIRTargetPtr _target){
    //    V3 t_verts[4];
    //    t_verts[0].x = m_rect.m_lb_pt.X;
    //    t_verts[0].y = m_rect.m_lb_pt.Y;
    //    t_verts[0].z = 0.0f;
...
void IMIRCmdCircleSolid::_render(IMIRendererPtr _renderer,IMIRTargetPtr _target){
    //    V3 t_verts[4];
    //    t_verts[0].x = m_rect.m_lb_pt.X;
    //    t_verts[0].y = m_rect.m_lb_pt.Y;
    //    t_verts[0].z = 0.0f;
...
//
void IMIRCmdAABB::setAABB(IMIBoundBox& _aabb){
    m_aabb = _aabb;
}
...
void IMIRCmdAABB::_render(IMIRendererPtr _renderer,IMIRTargetPtr _target){
    V3 t_verts[24];
    // 0-4
...
void IMIRCmdAABBSolid::_render(IMIRendererPtr _renderer,IMIRTargetPtr _target){
    V3 t_verts[24];
    // 0-4
    t_verts[0].x = m_aabb.getMin().x;
    t_verts[0].y = m_aabb.getMin().y;
