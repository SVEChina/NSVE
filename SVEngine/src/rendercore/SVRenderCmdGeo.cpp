...
//
void SVRCmdLine::setLine(FVec3& _start, FVec3& _end){
    m_start = _start;
    m_end = _end;
}

void SVRCmdLine::_render(SVRendererPtr _renderer,SVRTargetPtr _target){
//    V3 t_verts[2];
...
//
void SVRCmdRect::setRect(SVRect& _rect){
    m_rect = _rect;
}

void SVRCmdRect::_render(SVRendererPtr _renderer,SVRTargetPtr _target){
//    V3 t_verts[4];
...
void SVRCmdRectSolid::_render(SVRendererPtr _renderer,SVRTargetPtr _target){
//    V3 t_verts[4];
//    t_verts[0].x = m_rect.m_lb_pt.x;
//    t_verts[0].y = m_rect.m_lb_pt.y;
//    t_verts[0].z = 0.0f;
...
void SVRCmdCurve::_render(SVRendererPtr _renderer,SVRTargetPtr _target){
//    V3 t_verts[4];
//    t_verts[0].x = m_rect.m_lb_pt.X;
//    t_verts[0].y = m_rect.m_lb_pt.Y;
//    t_verts[0].z = 0.0f;
...
void SVRCmdCircle::_render(SVRendererPtr _renderer,SVRTargetPtr _target){
    //    V3 t_verts[4];
    //    t_verts[0].x = m_rect.m_lb_pt.X;
    //    t_verts[0].y = m_rect.m_lb_pt.Y;
    //    t_verts[0].z = 0.0f;
...
void SVRCmdCircleSolid::_render(SVRendererPtr _renderer,SVRTargetPtr _target){
    //    V3 t_verts[4];
    //    t_verts[0].x = m_rect.m_lb_pt.X;
    //    t_verts[0].y = m_rect.m_lb_pt.Y;
    //    t_verts[0].z = 0.0f;
...
//
void SVRCmdAABB::setAABB(SVBoundBox& _aabb){
    m_aabb = _aabb;
}
...
void SVRCmdAABB::_render(SVRendererPtr _renderer,SVRTargetPtr _target){
    V3 t_verts[24];
    // 0-4
...
void SVRCmdAABBSolid::_render(SVRendererPtr _renderer,SVRTargetPtr _target){
    V3 t_verts[24];
    // 0-4
    t_verts[0].x = m_aabb.getMin().x;
    t_verts[0].y = m_aabb.getMin().y;
