...
void SVResGLVBO::create(render::SVRendererPtr _renderer) {
    SVResVBO::create(_renderer);
}

void SVResGLVBO::destroy(render::SVRendererPtr _renderer) {
    SVResVBO::destroy(_renderer);
}

void SVResGLVBO::render(render::SVRendererPtr _renderer) {
...
void SVResGLRenderMesh::create(render::SVRendererPtr _renderer){
    SVResGLVBO::create(_renderer);
}

void SVResGLRenderMesh::destroy(render::SVRendererPtr _renderer) {
    if (m_indexID > 0) {
...
void SVResGLRenderMesh::render(render::SVRendererPtr _renderer) {
    render::SVRendererPtr t_renderer = mApp->getRenderer();
    if(!t_renderer) {
        return ;
    }
...
void SVResGLRenderMeshDvid::create(render::SVRendererPtr _renderer){
    SVResGLRenderMesh::create(_renderer);
}

void SVResGLRenderMeshDvid::destroy(render::SVRendererPtr _renderer) {
...
void SVResGLRenderMeshDvid::render(render::SVRendererPtr _renderer){
    render::SVRendererPtr t_renderer = mApp->getRenderer();
