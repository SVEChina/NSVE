...
void SVRenderTarget::create(render::SVRendererPtr _renderer) {
...
void SVRenderTarget::destroy(render::SVRendererPtr _renderer) {
    if (m_objFBOPtr) {
...
void SVRenderTargetDefault::create(render::SVRendererPtr _renderer) {
    SVRObjBase::create(_renderer);
    render::SVRendererPtr t_renderBasePtr = mApp->getRenderer();
    SVRendererGLPtr t_renderGLPtr = std::dynamic_pointer_cast<SVRendererGL>(t_renderBasePtr);
    if (t_renderGLPtr) {
...
void SVRenderTargetDefault::destroy(render::SVRendererPtr _renderer) {
    if (m_objFBOPtr) {
        m_objFBOPtr->destroy(_renderer);
    }
    SVRObjBase::destroy(_renderer);
...
void SVRenderTargetOut::create(render::SVRendererPtr _renderer) {
    SVRObjBase::create(_renderer);
    render::SVRendererPtr t_renderBasePtr = mApp->getRenderer();
    SVRendererGLPtr t_renderGLPtr = std::dynamic_pointer_cast<SVRendererGL>(t_renderBasePtr);
    if (t_renderGLPtr) {
...
void SVRenderTargetOut::destroy(render::SVRendererPtr _renderer) {
    if (m_objFBOPtr) {
        m_objFBOPtr->destroy(_renderer);
    }
    SVRObjBase::destroy(_renderer);
...
void SVRenderTargetOutTexture::create(render::SVRendererPtr _renderer) {
...
void SVRenderTargetOutTexture::destroy(render::SVRendererPtr _renderer) {
