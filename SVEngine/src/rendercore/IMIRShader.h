...
#ifndef IMI_RSHADER_H
#define IMI_RSHADER_H
...
namespace imi {
    ...
    struct ShaderDsp;
    class IMIRShader: public IMIRRes {
    public:
        IMIRShader(IMIInstPtr _app)
        :IMIRRes(_app)
        ...
        virtual void load(IMIRendererPtr _renderer,ShaderDsp* _shader_dsp){
        ...
        virtual bool active(IMIRendererPtr _render){ return false; }
