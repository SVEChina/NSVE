#ifndef IMI_PARTICLENODE_H
#define IMI_PARTICLENODE_H
...
namespace imi {
    ...
    //
    class IMIParticlesNode : public IMINode {
    public:
        IMIParticlesNode(IMIInstPtr _app);
        ...
        void setDiffuse(IMITexturePtr _texture);
        
        void setDiffuse(IMIString _texPath);
        
        // particles
        IMIParticlesPtr getParticles();
        ...
        void getParticleTransforms(IMIArray<FMat4> &transforms) const;
        //
        ...
        // bounds
        virtual const IMIBoundBox &getIMIBoundBox() const;
    ...
    protected:
        ...
        IMIParticlesPtr m_pParticles;           // particles pointer
        
        IMIParticlesWorldPtr m_pParticlesWorld;    // particles world
        ...
        IMIBoundBox bound_box;                     // 发射器包围盒就可以了
        //
        IMIMtlParticleAniPtr m_mtl_particle;
        IMIRenderMeshPtr m_pMesh;
        IMIDataSwapPtr m_pVertData;
        IMIDataSwapPtr m_pIndexData;
        IMITexturePtr m_diffuse;
        IMITexturePtr m_atten;
        IMIString m_texturePath;
        IMIString m_textureName;
