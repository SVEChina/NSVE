...
IMITrackerFace::IMITrackerFace(IMIInstPtr _app)
:IMIGBaseEx(_app) {
    m_img_w = 720;
    m_img_h = 1280;
    m_personID = 0;
...
IMITrackerFace::~IMITrackerFace() {

}

f32 IMITrackerFace::getEyeDis() {
...
f32 IMITrackerFace::getEyeStdScale(){
    f32 t_adapt_scale = mApp->m_config.getDesignAdaptScale();
    f32 t_scale = m_eyeDistance/ t_adapt_scale / STANDARD_EYE_STD;
    return t_scale;
}

f32 IMITrackerFace::getNoiseStdScale(){
    f32 t_adapt_scale = mApp->m_config.getDesignAdaptScale();
    f32 t_scale = m_noiseDistance/ t_adapt_scale / STANDARD_NOISE_STD;
    return t_scale;
}

void IMITrackerFace::track_st(void *_data, s32 _ptnum, IMIRect &_rect, f32 yaw, f32 pitch, f32 roll, s32 personID) {
...
void IMITrackerFace::setEnableExpression(bool _enable){
    m_enableExpression = _enable;
}

///
void IMITrackerFace::_trackExpression_st(){
...
void IMITrackerFace::_correctStandardface_st(){
    
}
///
void IMITrackerFace::_trackExpression_as(){
    
}

void IMITrackerFace::_correctStandardface_as(){
    
}
///
void IMITrackerFace::_trackExpression_fp(){
    
}

void IMITrackerFace::_correctStandardface_fp(){
    
}

void IMITrackerFace::_sendExpressionEvent(IMI_EVENT_TYPE _type){
    IMIEventPersonExpressionPtr t_event = MakeSharedPtr<IMIEventPersonExpression>();
