...
SVTrackerFace::SVTrackerFace(SVInstPtr _app)
:SVGBaseEx(_app) {
    m_img_w = 720;
    m_img_h = 1280;
    m_personID = 0;
...
SVTrackerFace::~SVTrackerFace() {

}

f32 SVTrackerFace::getEyeDis() {
...
f32 SVTrackerFace::getEyeStdScale(){
    f32 t_adapt_scale = mApp->m_config.getDesignAdaptScale();
    f32 t_scale = m_eyeDistance/ t_adapt_scale / STANDARD_EYE_STD;
    return t_scale;
}

f32 SVTrackerFace::getNoiseStdScale(){
    f32 t_adapt_scale = mApp->m_config.getDesignAdaptScale();
    f32 t_scale = m_noiseDistance/ t_adapt_scale / STANDARD_NOISE_STD;
    return t_scale;
}

void SVTrackerFace::track_st(void *_data, s32 _ptnum, SVRect &_rect, f32 yaw, f32 pitch, f32 roll, s32 personID) {
...
void SVTrackerFace::setEnableExpression(bool _enable){
    m_enableExpression = _enable;
}

///
void SVTrackerFace::_trackExpression_st(){
...
void SVTrackerFace::_correctStandardface_st(){
    
}
///
void SVTrackerFace::_trackExpression_as(){
    
}

void SVTrackerFace::_correctStandardface_as(){
    
}
///
void SVTrackerFace::_trackExpression_fp(){
    
}

void SVTrackerFace::_correctStandardface_fp(){
    
}

void SVTrackerFace::_sendExpressionEvent(SV_EVENT_TYPE _type){
