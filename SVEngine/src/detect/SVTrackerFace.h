...
#ifndef SV_TRACKER_FACE_H
#define SV_TRACKER_FACE_H
...
namespace sv {
    ...
    class SVTrackerFace : public SVGBaseEx {
    public:
        SVTrackerFace(SVInstPtr _app);
        
        virtual ~SVTrackerFace();
