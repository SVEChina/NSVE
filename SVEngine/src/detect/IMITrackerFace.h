...
#ifndef IMI_TRACKER_FACE_H
#define IMI_TRACKER_FACE_H

#include "../base/IMIGBase.h"
#include "../event/IMIEventDef.h"
...
namespace imi {
    ...
    class IMITrackerFace : public IMIGBaseEx {
    public:
        IMITrackerFace(IMIInstPtr _app);
        
        virtual ~IMITrackerFace();
        
        void track_st(void *_data, s32 _ptnum, IMIRect &_rect, f32 yaw, f32 pitch, f32 roll, s32 personID);
    ...
    protected:
        void _sendExpressionEvent(IMI_EVENT_TYPE _type);
        //精细表情识别
