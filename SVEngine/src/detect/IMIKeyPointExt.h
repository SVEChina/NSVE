...
#ifndef IMI_KEYPOINTEXT_H
#define IMI_KEYPOINTEXT_H
#include "../base/IMITypes.h"
#include "../core/IMIVertDef.h"
#include "../base/IMIVec2.h"
namespace imi {
        //sensetime
        class IMIKeyPointExt {
        public:
            ...
            static void faceDataForFaceTune(IMI_S_FACETUNE_RATIO &_attribute, f32 *faceLandMark, s32 keyPtNum, f32 *faceTunePts, s32 &facePtsCount);
